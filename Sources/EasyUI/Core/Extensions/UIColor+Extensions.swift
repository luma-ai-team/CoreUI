...
//  CleanProject
//
//  Created by Roi Mulia on 14/01/2020.
...
public extension UIColor {
    ...
    convenience init(hex: String) {
        ...
        guard Scanner(string: hexSanitized).scanHexInt32(&rgb) else {  self.init(displayP3Red: 0.3, green: 0.3, blue: 0.3, alpha: 1); return }
